...
// ====== HARDWARE ======
constexpr uint8_t pinLed = 26;      // Pino do LED integrado (GPIO 2)
constexpr uint8_t botaoMsg = 18;    // Pino do botão (GPIO 0)
...
void setup()
{
    ...
    botaoMsgJussa.attach(botaoMsg, INPUT_PULLUP);
    botaoMsgJussa.interval(25);
}

void processarBotoes()
{
   botaoMsgJussa.update();
